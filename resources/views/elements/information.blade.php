        ...
        <div class="col-md-6 col-sm-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="http://packalyst.com/" class="pull-right label label-info" title="Packalyst :: Packages for Laravel" target="_blank">View all</a>
                ...
                <div class="panel-body">
                    ...
                    @foreach($feeder as $feed)
                        <li>
                            ...
                            <a href="{{$feed->link}}" title="{{$feed->content}}" target="_blank">{{$feed->title}}</a>&nbsp;
