<ul class="linker social">
    <li>
        <a href="http://b.hatena.ne.jp/entry/{{Request::url()}}" class="hatena-bookmark-button"
           data-hatena-bookmark-title="@yield('title', Config::get('recipe.title'))"
    ...
    <li>
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="{{Request::url()}}"
           data-text="@yield('title', config('recipe.title'))">Tweet</a>
    </li>
    <li>
